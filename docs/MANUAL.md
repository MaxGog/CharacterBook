...
- **🔗 Связи между персонажами** - Семейные узы, отношения
...
| **📝 Word (DOCX)** | Высокое | Редактируемые документы, печать |
...
- **🔄 Регулярные бэкапы** - При каждом заходе приложения
...
| **Подготовка к сессии** | Экспорт в PDF, Word + групповые действия | Экономия времени на подготовку |
